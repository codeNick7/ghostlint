...
from tiramisu_engine.models.findings import ScanResult, RiskLevel, HealthScore, GitMetrics
...
<title>tiramisu · {_h(repo_name)}</title>
...
<footer>Generated by tiramisu · {_h(scan_date)}</footer>
