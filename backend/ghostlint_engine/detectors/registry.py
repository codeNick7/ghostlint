...
def _load() -> dict[str, EngineSpec]:
    ...
    from ghostlint_engine.detectors.arch_drift.detector import ArchDriftDetector
    from ghostlint_engine.detectors.config_health.detector import ConfigHealthDetector
    from ghostlint_engine.detectors.doc_health.detector import DocHealthDetector
    from ghostlint_engine.detectors.dependency_health.detector import DependencyHealthDetector
    from ghostlint_engine.detectors.test_health.detector import TestHealthDetector
    from ghostlint_engine.detectors.naming.detector import NamingConsistencyDetector
