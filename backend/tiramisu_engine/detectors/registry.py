...
def _load() -> dict[str, EngineSpec]:
    ...
    from tiramisu_engine.detectors.dead_code import DeadCodeDetector
    ...
    from tiramisu_engine.detectors.arch_drift.detector import ArchDriftDetector
    from tiramisu_engine.detectors.config_health.detector import ConfigHealthDetector
    from tiramisu_engine.detectors.doc_health.detector import DocHealthDetector
    from tiramisu_engine.detectors.dependency_health.detector import DependencyHealthDetector
    from tiramisu_engine.detectors.test_health.detector import TestHealthDetector
    from tiramisu_engine.detectors.naming.detector import NamingConsistencyDetector
