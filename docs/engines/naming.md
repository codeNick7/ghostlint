...
```bash
ghostlint scan -e naming --min-confidence 0.75
```

## Running This Engine

```bash
ghostlint scan -e naming
ghostlint scan -e naming --min-confidence 0.75
```
